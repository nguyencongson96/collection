...
import { GENRE_LIST_URL } from "@/utlis/constant";
...
const Genres: FunctionComponent = (props: any) => {
    ...
    useEffect(() => {
        axiosClient
            .get(`${GENRE_LIST_URL}?limit=${limit}&page=${page}`)
            .then((res) => {
...
export async function getServerSideProps(context: any) {
    let breadcrumbs = [{ title: "Dashboard", href: "/admin"}, {title: "Genres"}];
